...
def like(request):
    ...
    return JsonResponse({"code": 0, "likers": video.count_likers(), "user_liked": video.user_liked(user)})
...
def collect(request):
    ...
    return JsonResponse(
        {"code": 0, "collecters": video.count_collecters(), "user_collected": video.user_collected(user)})
